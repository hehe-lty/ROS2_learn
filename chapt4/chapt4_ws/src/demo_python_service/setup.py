...
setup(
    ...
    data_files=[
        ...
        'resource/test1.jpg', 'resource/test2.jpg', 'resource/test3.jpg']),
    ],
    install_requires=['setuptools'],
    zip_safe=True,
    maintainer='rick',
    maintainer_email='1570668005@qq.com',
    ...
    entry_points={
        'console_scripts': [
            ...
            'face_detect_clint_node = demo_python_service.face_detect_clint_node:main',
